...
<body>
    ...
    <form class="msform" action="../objetos/objeto_cliente.php" method="post" id="myForm">
        ...
        <fieldset>
          ...
          <input type="text" id="txtNit" name="txtNit" placeholder="Ingrese su nit" autocomplete="off">
