...
<!-- se usa el método post -->
     <form class="msform" action="../objetos/objeto_cobro.php" method="post">
        <!-- FORMULARIO DE PERSONA-->
        <fieldset>
          <h2 class="fs-title">Formulario de cobros</h2>
          <br>
          ...
          <input type="number" id="txtComisionCobro" name="txtComisionCobro" placeholder="Ingrese la comisión de cobro" autocomplete="off">
