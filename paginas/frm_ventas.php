...
<!-- se usa el método post -->
     <form class="msform" action="../objetos/objeto_ventas.php" method="post">
        <!-- FORMULARIO DE PERSONA-->
        <fieldset>
          <h2 class="fs-title">Formulario de ventas</h2>
          <br>
          ...
          <input type="text" id="txtTipoContra" name="txtTipoContra" placeholder="Ingrese el tipo de contratación" autocomplete="off">
          <input type="number" id="txtComisionVenta" name="txtComisionVenta" placeholder="Ingrese la comisión de venta" autocomplete="off">
